...
<head>
    ...
    <script type="text/javascript">
	    function onEditClick(userid, user_nm, frm) {
	        /* 編集ボタン押下*/
			var newWin = window.open(
				"<?php echo BASE_URL ?>directurl/redirect/admagyreg/update/" + userid,
		        "観光パンフ",
	    ...
	    function onDeleteClick(userid) {
	    	...
	    	var arguments = userid;
			 ...
			 {
	    	    location.href = "<?php echo BASE_URL ?>admagylist/delete/" + userid;
			}
    		else
    		{
    		}
...
<?php echo form_open('admagylist'); ?>
  ...
  <div class="row" id="main">
  	<div class="span3" style="background:lightgray; height:550px;">
    	...
    	<li><a href="<?php echo BASE_URL ?>admmain">トップメニュー</a></li></ul>
  	</div>
  	<div class="span9" style="height:550px;">
  		<div class="row">
  		<div class="span8" style="height:65px;" id="search">
  			<form action="">
    		    <table class="style" style="position:absolute; top:120px">
                	<tr>
                    	<td align="left">
	                    	<div style="float:left;">代理店名で検索：</div>
       		...
       		<table class="table table-striped table-bordered table-hover table-condensed" id="myTable" >
                ...
                <tbody>
					...
					<tr>
						...
						<td width="40">
    						<button type="button" class="btn" name="edit" value=<?=$row->user_id ?> onClick="onEditClick(<?=$row->user_id ?>, '<?=$row->user_nm ?>',this);">編集</button>
                        </td>
                        <td width="50">
